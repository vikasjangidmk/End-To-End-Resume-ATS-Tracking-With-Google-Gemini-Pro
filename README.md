...
```bash
git clone https://github.com/vikasjangidmk/End-To-End-Resume-ATS-Tracking-With-Google-Gemini-Pro.git
cd End-To-End-Resume-ATS-Tracking-With-Google-Gemini-Pro
```

2. Create Virtual Environment
```bash
conda create -p P3 python=3.10 -y
```
